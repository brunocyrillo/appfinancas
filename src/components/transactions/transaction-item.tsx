    ...
    <>
      <div className="flex items-center gap-3 py-3 px-4 hover:bg-slate-50 rounded-lg transition-colors group">
        ...
        <div className="flex items-center gap-3">
          <Badge variant={transaction.type === "income" ? "income" : "expense"} className="text-xs hidden sm:flex">
      ...
      <TransactionForm open={editOpen} onClose={() => setEditOpen(false)} transaction={transaction} />
